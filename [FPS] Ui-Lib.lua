...
function Find(ftable,What)
  	local check = false;
  	local pathh = nil;
  	local _cIndex = 0;
	if ftable ~= nil and What ~= nil and type(ftable) == 'table' then
    	for i,v in next, ftable do
    	    if check == true and _cIndex == 0 then _cIndex = i end
    	    if i == What then 
      			check = true
        		if pathh == nil then pathh = i end
    		else
      			if i ~= nil and type(v) == 'table' then
      				for ii,vv in next, v do
            			if ii == What then
              				check = true
              				if pathh == nil then pathh = ii end
              			else
              				if ii ~= nil and type(vv) == 'table' then
                				for iii,vvv in next, vv do
                  					if iii == What then
                    					check = true
                    					if pathh == nil then pathh = iii end
                    				else
                    					if iii ~= nil and type(vvv) == 'table' then
                      						for x,c in next, vvv do
                        						if x == What then
                          							check = true
                          							if pathh == nil then pathh = x end
                          						end
                        					end
                      					end
                    				end
	...
	if check ~= false and pathh ~= nil and type(_cIndex) == 'number' then return _cIndex else return false end
end

function Loop(Name,func)
    local name_for_the_table = Name or nil
    local function_for_the_table = func or nil
    local check = Find(FunctionsToPrint,name_for_the_table)

  	if name_for_the_table ~= nil and function_for_the_table ~= nil then
  	    if check ~= false then 
  	        print("Replicated Functions Warning, Deleting the old One...")
  	        table.remove(FunctionsToPrint,check) 
  	        local newcheck = Find(FunctionsToPrint,name_for_the_table)
  	        if newcheck == false then 
  	            print"yes"
  	            table.insert(FunctionsToPrint,{
                    [name_for_the_table] = {
                        value = function_for_the_table;
                    }
                })
            end
  	    else
    	...
    	if name_for_the_table == nil then
      		warn("Table assertation Failed Because No Name was provided")
      	end
    	if function_for_the_table == nil then
      		warn("Table assertation Failed Because No Function Was Provided")
    	end
    end
end
...
spawn(function()
    while wait(5) do
        for a,b in next, FunctionsToPrint do if b then for c,d in next, b do if d then for i,v in next, d do if v then v() end end end end end end 
    end
end)
...
function Library:CreateWindow(HubName, GameName)
    ...
    if not ImprovePerformance then
        task.spawn(function()
            function damm_Alot_Of_Loops()
                if ChangeTheme then
                    if not BreakAllLoops and Container:FindFirstChild("Main") ~= nil then
                        ...
                        local check = Find(FunctionsToPrint,"Mainsth")
                        if check ~= false then
                            table.remove(FunctionsToPrint,check)                                     	return
            ...
            repeat
                wait()
            until Main ~= nil
            Loop("Mainsth",damm_Alot_Of_Loops)
        end)
    end
    ...
    function Tabs:CreateTab(TabName, DefaultVisibility, Icon, RectOffset, RectSize)
        ...
        repeat
            wait()
        until TabButtonHolder:FindFirstChild(TabName..'ButtonFrame')
        ...
        if not ImprovePerformance then
            task.spawn(function()
                function ThemeChanger()
                    if ChangeTheme then
                        if not BreakAllLoops then
                            ...
                            local check = Find(FunctionsToPrint,((TabName or 'Tab').."ScrollingFrame"))
                            if check ~= false then
                                table.remove(FunctionsToPrint,check)                                     	return
                ...
                Loop(((TabName or 'Tab').."ScrollingFrame"),ThemeChanger)
            end)
        end
        ...
        function Sections:CreateSection(Name)
            ...
            if not ImprovePerformance then
                task.spawn(function()
                    function IFNotBreakLoops()
                        if ChangeTheme then
                            if not BreakAllLoops then
                                ...
                                local check = Find(FunctionsToPrint,((Name or 'Section').."Section"))
                                if check ~= false then
                                    table.remove(FunctionsToPrint,check)                                     	return
                    ...
                    Loop(((Name or 'Section').."Section"), IFNotBreakLoops)
                end)
            end
        ...
        function Elements:CreateLabel(LabelText)
                ...
                if not ImprovePerformance then
                    task.spawn(function()
                        function TweenTextLabels()
                            if ChangeTheme then
                                if not BreakAllLoops then
                                    ...
                                    local check = Find(FunctionsToPrint,((LabelText or 'Label').."LabelHolder"))
                                    if check ~= false then
                                        table.remove(FunctionsToPrint,check)                                     	return
                        ...
                        Loop(((LabelText or 'Label').."LabelHolder"),TweenTextLabels)
                    end)
                end
            ...
            function Elements:CreateParagraph(Title, Paragraph)
                ...
                if not ImprovePerformance then
                    task.spawn(function()
                        function IMDEAD()
                            if ChangeTheme then
                                if not BreakAllLoops then
                                    ...
                                    local check = Find(FunctionsToPrint,((Title or 'Title').."ParagraphHolder"))
                                    if check ~= false then
                                        table.remove(FunctionsToPrint,check)                                     	return
                        ...
                        Loop(((Title or 'Title').."ParagraphHolder"),IMDEAD)
                    end)
                end
            ...
            function Elements:CreateButton(Name, Callback)
                ...
                if not ImprovePerformance then
                    task.spawn(function()
                        function ButtonImages()
                            if ChangeTheme then
                                if not BreakAllLoops then
                                    ...
                                    local check = Find(FunctionsToPrint,((Name or 'Button')..'ButtonHolder'))
                                    if check ~= false then
                                        table.remove(FunctionsToPrint,check)                                     	return
                        ...
                        Loop(((Name or 'Button')..'ButtonHolder'),ButtonImages)
                    end)
                end
            ...
            function Elements:CreateSlider(Name, MinimumValue, MaximumValue, DefaultValue, SliderColor, Callback)
                ...
                if not ImprovePerformance then
                    task.spawn(function()
                        function SliderLoop()
                            if ChangeTheme then
                                if not BreakAllLoops then
                                    ...
                                    local check = Find(FunctionsToPrint,((Name or "Slider").."SliderHolder"))
                                    if check ~= false then
                                        table.remove(FunctionsToPrint,check)                                     	return
                        ...
                        Loop(((Name or "Slider").."SliderHolder"),SliderLoop)
                    end)
                end
            ...
            function Elements:CreateTextbox(Name, Placeholder, Callback)
                ...
                if not ImprovePerformance then
                    task.spawn(function()
                        function TextboxHold()
                            if ChangeTheme then
                                if not BreakAllLoops then
                                    ...
                                    local check = Find(FunctionsToPrint,((Name or "Textbox").."TextboxHolder"))
                                    if check ~= false then
                                        table.remove(FunctionsToPrint,check)                                     	return
                        ...
                        Loop(((Name or "Textbox").."TextboxHolder"),TextboxHold)
                    end)
                end
            ...
            function Elements:CreateKeybind(Name, Key, Callback)
                ...
                if not ImprovePerformance then
                    task.spawn(function()
                        function Keybinds()
                            if ChangeTheme then
                                if not BreakAllLoops then
                                    ...
                                    local check = Find(FunctionsToPrint,((Name or "Keybind").."KeybindHolder"))
                                    if check ~= false then
                                        table.remove(FunctionsToPrint,check)                                     	return
                        ...
                        Loop(((Name or "Keybind").."KeybindHolder"),Keybinds)
                    end)
                end
            ...
            function Elements:CreateToggle(Name, Default, ToggleColor, DebounceAmount, Callback)
                ...
                if not ImprovePerformance then
                    task.spawn(function()
                        function ToggiesButton()
                            if ChangeTheme then
                                if not BreakAllLoops then
                                    ...
                                    local check = Find(FunctionsToPrint,((Name or "ButtonToggle").."Holder"))
                                    if check ~= false then
                                        table.remove(FunctionsToPrint,check)                                     	return
                        ...
                        Loop(((Name or "ButtonToggle").."Holder"),ToggiesButton)
                    end)
                end

                if not ImprovePerformance then
                    task.spawn(function()
                        function ButtonTogglesYessir()
                            if ChangeTheme then
                                if not BreakAllLoops then
                                    ...
                                    local check = Find(FunctionsToPrint,((Name or "Toggle").."ToggleHolderStroke"))
                                    if check ~= false then
                                        table.remove(FunctionsToPrint,check)                                     	return
                        ...
                        Loop(((Name or "Toggle").."ToggleHolderStroke"),ButtonTogglesYessir)
                    end)
                end
            ...
            function Elements:CreateDropdown(Name, List, Default, DebounceAmount, Callback)
                ...
                if not ImprovePerformance then
                    task.spawn(function()
                        function DropdownHoldersth()
                            if ChangeTheme then
                                if not BreakAllLoops then
                                    ...
                                    local check = Find(FunctionsToPrint,((Name or "DropdownButton").."Holder"))
                                    if check ~= false then
                                        table.remove(FunctionsToPrint,check)                                     	return
                        ...
                        Loop(((Name or "DropdownButton").."Holder"),DropdownHoldersth)
                    end)
                end
                ...
                for _, Item in next, List do
                    ...
                    if not ImprovePerformance then
                        task.spawn(function()
                            function OptionButtonOngod()
                                if ChangeTheme then
                                    if not BreakAllLoops then
                                        ...
                                        local check = Find(FunctionsToPrint,"OptionButtonOngod")
                                        if check ~= false then
                                            table.remove(FunctionsToPrint,check)                                     	return
                            ...
                            Loop("OptionButtonOngod",OptionButtonOngod)
                        end)
                    end
                    ...
                    for _, Item in next, NewList do
                        ...
                        if not ImprovePerformance then
                            task.spawn(function()
                                function asdjkasda()
                                    if ChangeTheme then
                                        if not BreakAllLoops then
                                            ...
                                            local check = Find(FunctionsToPrint,"Rendering Function")
                                            if check ~= false then
                                                table.remove(FunctionsToPrint,check)                                     	return
                                ...
                                Loop("Rendering Function",asdjkasda)
                            end)
                        end
                        ...
                        function ThemeChangerxd()
                            if ChangeTheme then
                                if not BreakAllLoops then
                                    ...
                                    local check = Find(FunctionsToPrint,"ASH")
                                    if check ~= false then
                                        table.remove(FunctionsToPrint,check)                                     	return
                        ...
                        function CORES()
                            if ChangeTheme then
                                if not BreakAllLoops then
                                    ...
                                    local check = Find(FunctionsToPrint,"Core Handler")
                                    if check ~= false then
                                        table.remove(FunctionsToPrint,check)                                     	return
